...
final class Color
{
    private const COLORS = [
        ...
        'danger' => [
            'solid' => 'bg-rose-600 text-white border-rose-700 dark:bg-rose-500 dark:border-rose-400',
            'icon' => 'bg-rose-600',
            'soft' => 'bg-rose-50 text-rose-800 border-rose-200 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-900/60',
            'outline' => 'border-rose-600 text-rose-600 dark:border-rose-400 dark:text-rose-400',
            'border' => 'border-rose-600 dark:border-rose-400',
            'text' => 'text-rose-600 dark:text-rose-400',
            'progress' => 'bg-rose-600 dark:bg-rose-500',
            'glass' => 'bg-rose-50 dark:bg-rose-950/20 border-white/30 dark:border-rose-400/10 shadow-rose-500/10',
            'glass-icon' => 'bg-rose-500/10 border-rose-200/30 dark:border-rose-400/10 text-rose-700 dark:text-rose-300',
            'glass-badge' => 'bg-rose-200/70 dark:bg-rose-800/50',
        ],
        'info' => [
