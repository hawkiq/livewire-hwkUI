# Install hwkUI VS Code Snippets

## Per-project installation

The package already includes a workspace snippet file at [.vscode/package.code-snippets](.vscode/package.code-snippets).
...
Copy the generated file into your VS Code user snippets folder or use the workspace version in [.vscode/package.code-snippets](.vscode/package.code-snippets).
